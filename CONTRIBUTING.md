...
If you find a bug, please submit an [issue](https://github.com/gazbert/spring-boot-mongodb-app/issues).
...
Review the [issues list](https://github.com/gazbert/spring-boot-mongodb-app/issues) and find something
...
To work on something, whether a new feature or a bug fix:
  ...
  ```
  git clone https://github.com/<your-id>/spring-boot-mongodb-app.git
  ```
  3. Add the upstream repository as a remote: 
  ```
  git remote add upstream https://github.com/gazbert/spring-boot-mongodb-app.git
  ```  
...
* We like static analysis: the build uses [JaCoCo](https://www.jacoco.org/jacoco/) to enforce code 
  ...
  [Sonorcloud](https://sonarcloud.io/dashboard?id=gazbert_spring-boot-mongodb-app) is used
